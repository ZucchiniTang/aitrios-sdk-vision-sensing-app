...
#ifndef FLATBUFFERS_GENERATED_SWITCHDNNOBJECTDETECTION_SMARTCAMERA_H_
#define FLATBUFFERS_GENERATED_SWITCHDNNOBJECTDETECTION_SMARTCAMERA_H_
...
struct GeneralObject FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  bool is_used_for_cropping() const {
    return GetField<uint8_t>(VT_IS_USED_FOR_CROPPING, 0) != 0;
  }
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyField<uint8_t>(verifier, VT_IS_USED_FOR_CROPPING, 1) &&
           verifier.EndTable();
  }
};
...
struct GeneralObjectBuilder {
  ...
  void add_is_used_for_cropping(bool is_used_for_cropping) {
    fbb_.AddElement<uint8_t>(GeneralObject::VT_IS_USED_FOR_CROPPING, static_cast<uint8_t>(is_used_for_cropping), 0);
  }
...
struct ObjectDetectionTopBuilder {
  ...
  void add_trace_id(uint64_t trace_id) {
    fbb_.AddElement<uint64_t>(ObjectDetectionTop::VT_TRACE_ID, trace_id, 0);
  }
...
#endif  // FLATBUFFERS_GENERATED_SWITCHDNNOBJECTDETECTION_SMARTCAMERA_H_
